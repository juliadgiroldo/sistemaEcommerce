...
from .views import CarrinhoViewSet, CategoriaViewSet, ForncedorViewSet, ProdutoViewwSet, LoginUserAPIView, createAccountUser
...
router.register(r'carrinho', CarrinhoViewSet, basename='carrinhos')

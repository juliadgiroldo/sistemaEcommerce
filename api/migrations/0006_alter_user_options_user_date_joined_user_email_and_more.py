...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('api', '0005_alter_pedidoitem_quantidade'),
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='user',
            name='email',
            field=models.CharField(default='adim@admin.com', max_length=256, unique=True, validators=[django.core.validators.RegexValidator(code='email_invalido', message='Email invalido', regex='^\\[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\\.[A-Z|a-z]{2,}$')]),
